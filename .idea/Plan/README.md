...
| ID       | Name           | GitHub                                                             | Role                  | Skill Level                      | Primary Area                                                             |
| -------- | -------------- | ------------------------------------------------------------------ | --------------------- | -------------------------------- | ------------------------------------------------------------------------ |
| OMH-GSA  | Guna Palanivel | [@GunaPalanivel](https://github.com/GunaPalanivel)                 | Architect / Tech Lead | Senior (111 repos, MLSA Beta)    | Agent orchestrator, MCP client, governance engine, PR review, submission |
| OMH-PSTL | Priyanka Sen   | [@PriyankaSen0902](https://github.com/PriyankaSen0902)             | Senior Builder        | Mid-Level (2 repos)              | MCP client SDK, tool-calling, API integration, governance flows          |
| OMH-ATL  | Aravind Sai    | [@aravindsai003](https://github.com/aravindsai003)                 | Builder / Validator   | Mid-Level (1 repo, Docker ready) | Chat UI, Docker OM setup, integration testing, validation                |
| OMH-BSE  | Bhawika Kumari | [@5009226-bhawikakumari](https://github.com/5009226-bhawikakumari) | Delivery / Docs       | New to Coding (1 repo)           | README, demo video, GFI PR, documentation, demo prep                     |
...
```
PLAN → BUILD → VALIDATE → FIX → VALIDATE → PR DRAFT → @GunaPalanivel REVIEW → MERGE
```

- No self-merges — all PRs reviewed by @GunaPalanivel
